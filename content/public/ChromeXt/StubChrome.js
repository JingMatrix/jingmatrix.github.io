...
export class StubStorage extends StubState {
  remove() {
    return stub(this, arguments);
  }
  getBytesInUse() {
...
function stub(_self, args) {
  try {
    console.debug(
      new Error(args.callee.name + " is not implemented yet by ChromeXt")
    );
  } catch {
    console.debug(new Error("Stub class is not implemented yet by ChromeXt"));
  }
}
